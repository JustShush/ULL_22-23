...
// verificar se sao notas validas
void val(int M, int m) {

	if (M > 20) printf("A nota maxima nao pode ser maior que 20!\n");
	if (M < 0) printf("A nota maxima nao pode ser menor que 0!\n");

	if (m > 20) printf("A nota minima nao pode ser maior que 20!\n");
	if (m < 0) printf("A nota minima nao pode ser menor que 0!\n");
}
...
void addDis(DISCIPLINA *disciplina, int *i)
{
	...
	val(disciplina[(*i)].notmax, disciplina[(*i)].notmin);
	
	if (disciplina[(*i)].notmax < disciplina[(*i)].notmin) printf("A nota minima nao pode ser maior que a nota maxima!\n");
	else {
